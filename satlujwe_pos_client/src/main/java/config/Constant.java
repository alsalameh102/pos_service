...
public interface Constant {
    ...
    public static final String POS_URL = "POS_URL";
...
//fxml paths
    ...
    public static final String RECEIPT_PREVIEW_FXML_PATH = "/fxml/ReceiptPreview.fxml";
    ...
    public static final String REPORT_PRINT_ERROR =  "Error while printing receipt";
    ...
    //Reciept Parameters
    public static final String RECEIPT_INVOICEPREF = "RECEIPT_INVOICEPREF";
    public static final String RECEIPT_STORENAME="RECEIPT_STORENAME";
    public static final String RECEIPT_STOREADDRESS1="RECEIPT_STOREADDRESS1";
    public static final String RECEIPT_STOREADDRESS2="RECEIPT_STOREADDRESS2";
    public static final String RECEIPT_FOOTERMESSAGE="RECEIPT_FOOTERMESSAGE";
    public static final String JASPER_LOCATION="jasper/receipt.jasper";
    
    
    //Shortcut parameters
    
    public static final String SHORTCUT_PAY="SHORTCUT_PAY";
    public static final String SHORTCUT_HOLD="SHORTCUT_HOLD";
    public static final String SHORTCUT_VOID="SHORTCUT_VOID";
    public static final String SHORTCUT_RITEM="SHORTCUT_RITEM";
    public static final String SHORTCUT_OPTIONS="SHORTCUT_OPTIONS";
}
