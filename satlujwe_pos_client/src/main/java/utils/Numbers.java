...
public class Numbers {
    ...
    public static double getTaxedUnitPrice(double unitPrice, double tax){
        return unitPrice + (unitPrice * tax);
    }
    
    public static double getTax(double unitPrice, double tax){
        return unitPrice * (tax/100);
    }
